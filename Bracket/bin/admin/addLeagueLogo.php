...
<div class="content">
	...
	<div class="formBody" id="theForm">
			<h1>Add League</h1>
			<h2>Step 2: Upload League Logo</h2>
			<form action="scripts/leagueLogoUpload.php" method="post" name="sleeker" id="sleeker" enctype="multipart/form-data">
				...
				<?php  echo "<input type=\"hidden\" name=\"colorChoice\" value=\"";
				echo $_POST["color"];
				echo "\" />"; ?>
				<input type="hidden" name="maxH" value="200" />
				<input type="hidden" name="filename" value="filename" />
				<input type="file" value="Upload Logo" name="filename" onchange="ajaxUpload(this.form,'scripts/leagueLogoUpload.php?filename=name&amp;maxSize=9999999999&amp;maxW=200&amp;fullPath=http://kylebeikirch.com/usoc/admin/uploads/&amp;relPath=../uploads/&amp;colorR=255&amp;colorG=255&amp;colorB=255&amp;maxH=200&amp;','upload_area','File Uploading Please Wait...&lt;br /&gt;&lt;img src=\'images/loader_light_blue.gif\' width=\'128\' height=\'15\' border=\'0\' /&gt;','&lt;img src=\'images/error.gif\' width=\'16\' height=\'16\' border=\'0\' /&gt; Error in Upload, check settings and path info in source code.'); return false;" />
			</form>
